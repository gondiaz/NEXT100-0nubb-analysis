...
OUTDIR="$LUSTRE/NEXT100/137Xe/nexus/"

OUTFILE="$NODEOUTDIR/nexus_$((RNDSEED))_137Xe"
...
# generator
echo "/Generator/IonGenerator/region        ACTIVE"    >> $CFG_MACRO
echo "/Generator/IonGenerator/atomic_number 54"        >> $CFG_MACRO
echo "/Generator/IonGenerator/mass_number   137"       >> $CFG_MACRO
echo "/Generator/IonGenerator/decay_at_time_zero true" >> $CFG_MACRO
