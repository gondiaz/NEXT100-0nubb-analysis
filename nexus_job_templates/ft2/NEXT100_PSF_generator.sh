...
OUTFILE="$NODEOUTDIR/nexus_${SLURM_ARRAY_TASK_ID}_psf"

OUTDIR="$LUSTRE/NEXT100/LightTables/sipm/"
...
# generator
echo "/Generator/ScintGenerator/region   EL_GAP"          >> ${CFG_MACRO}
...
echo "/Geometry/Next100/el_gap_gen_disk_zmin  0.0"        >> ${CFG_MACRO}
echo "/Geometry/Next100/el_gap_gen_disk_zmax  1.0"        >> ${CFG_MACRO}
